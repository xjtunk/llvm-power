// --- This file describes a power-pass over X86 code right before
// code emission.
// ---
...
FunctionPass *llvm::createX86PowerOptimizationPass() { return new PowerOpt(); }
...
///
bool PowerOpt::runOnMachineFunction(MachineFunction &MF) {
...
///
bool PowerOpt::processBasicBlock(MachineFunction &MF, MachineBasicBlock &BB) {
  bool Changed = false;
  MBB = &BB;
...
///
void PowerOpt::popStackAfter(MachineBasicBlock::iterator &I) {
...
void PowerOpt::freeStackSlotAfter(MachineBasicBlock::iterator &I, unsigned FPRegNo) {
...
///
void PowerOpt::handleZeroArgFP(MachineBasicBlock::iterator &I) {
  MachineInstr *MI = I;
...
///
void PowerOpt::handleOneArgFP(MachineBasicBlock::iterator &I) {
  MachineInstr *MI = I;
...
///     R1 = fadd R2, [mem]
///
void PowerOpt::handleOneArgFPRW(MachineBasicBlock::iterator &I) {
  MachineInstr *MI = I;
  unsigned NumOps = MI->getDesc().getNumOperands();
...
///
void PowerOpt::handleTwoArgFP(MachineBasicBlock::iterator &I) {
...
///
void PowerOpt::handleCompareFP(MachineBasicBlock::iterator &I) {
  ASSERT_SORTED(ForwardST0Table); ASSERT_SORTED(ReverseST0Table);
  ASSERT_SORTED(ForwardSTiTable); ASSERT_SORTED(ReverseSTiTable);
  MachineInstr *MI = I;
...
void PowerOpt::handleCondMovFP(MachineBasicBlock::iterator &I) {
  MachineInstr *MI = I;
...
/// instructions.
///
void PowerOpt::handleSpecialFP(MachineBasicBlock::iterator &I) {
  MachineInstr *MI = I;
  switch (MI->getOpcode()) {
